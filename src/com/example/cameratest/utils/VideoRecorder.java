...
public class VideoRecorder extends SurfaceView implements SurfaceHolder.Callback, FileReadyListener{
	...
	private static File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES), "Cabecao");
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		try {
            ...
            Log.d("VideoPreview", "Error setting camera preview: " + e.getMessage());
        }
	}
	...
	private boolean prepareVideoRecorder() {
	    ...
	    mMediaRecorder.setVideoSize(640, 480); // Its is not on android docs but it needs to be done. (640x480 = VGA resolution)
